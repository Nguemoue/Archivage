...
@section("content")
	...
	<hr>
	@can(config('perm_names.CREATE_USER'))
			...
			<table class="table datatable">
				...
				@foreach($accountList as $item)
					<tr>
						...
						<td>
							@can(config('perm_names.MAN_USER'))
								<div class="d-flex">
									<a href="#" data-toggle="modal" class="btn btn-outline-info btn-sm"
										data-target="#modalEdit{{$item->id}}"><i class="fa fa-pencil"></i></a>
									@includeIf("admin.userAccount.includes.modalEdit",['item'=>$item])
									<form action="{{route('admin.user.account.delete',['userId'=>$item->id])}}" method="post">
										@csrf
										<button type="submit" class="btn btn-sm btn-outline-danger"><i class="fa fa-trash"></i>
										</button>
									</form>
									<a href="#" data-toggle="modal" class="btn btn-outline-info btn-sm"
										data-target="#modalPermission{{$item->id}}"><i class="fa fa-key"></i></a>
									@includeIf("admin.userAccount.includes.modalPermission",['item'=>$item])
