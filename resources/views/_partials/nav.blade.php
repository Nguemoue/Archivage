                        ...
                        <li class="waves-effect waves-light">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="notification-msg">Consultation effectuer avec success.</p>
                        ...
                        <li class="waves-effect waves-light">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="notification-msg">Vous avez archivez un nouveau dossier.</p>
                                    <span class="notification-time">30 minutes ago</span>
                                </div>
                            </div>
                        </li>
                        <li class="waves-effect waves-light">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="notification-msg">Impression reussi.</p>
                                    <span class="notification-time">30 minutes ago</span>
                                </div>
                            </div>
                        </li>
