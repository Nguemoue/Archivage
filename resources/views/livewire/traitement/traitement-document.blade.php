<div>
			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-6 col-xl-6 col-xxl-6">
					<div class="mb-4">
						...
						<select wire:model.live.change="documentType" id="type" class="form-select">
				...
				<div class="col-sm-12 col-md-6 col-xl-6 col-xxl-6">
					<div class="mb-2">
						...
						<select wire:model='documentSubType' id="soustype" class="form-select">
							<option selected hidden=""> --- Selectionner une valeur ----</option>
	...
	@elseif ($step == 2)
		<form method="post"  id="formDocumentField"
				action="{{route('traitement.document.updateData',[$document->id])}}">
			@csrf
			...
			<div class="d-block text-center d-flex justify-content-between mt-2">
				<button type="button" class="btn btn-danger btn-sm" wire:click='prev'> <i class="ti ti-arrow-left"></i> Precedent</button>
				<button type="submit" class="btn btn-primary">Terminer <i class="ti ti-send"></i> </button>
			</div>
		</form>
	@endif
